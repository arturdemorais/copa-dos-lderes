...
const defaultTheme = {
  ...
  extend: {
    ...
    animation: {
      ...
      "stadium-lights": "stadium-lights 3s ease-in-out infinite",
      "goal-celebration": "goal-celebration 0.6s ease-out",
      "score-pop": "score-pop 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275)",
    },
    borderRadius: {
      sm: "var(--radius-sm)",
      md: "var(--radius-md)",
