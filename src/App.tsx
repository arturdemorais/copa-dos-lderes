  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="border-b bg-card sticky top-0 z-40">
        <div className="container mx-auto px-6 sm:px-8 lg:px-16 xl:px-24 py-4 max-w-[1400px]">
      ...
      <main className="container mx-auto px-6 sm:px-8 lg:px-16 xl:px-24 py-8 max-w-[1400px]">
        {children}
      </main>
    </div>
  );
